                ...
                <div id="main-content" class="border pad10">
                    ...
                    <div class="related-post">
                        ...
                        <?php
                         for($i=0;$i<count($result_detailq);$i++)
                         {
                             $Summary = $result_detailq[$i]['noidung_en'];
                         ...
                         <div class="col-md-4 col-sm-6">
                                <div class="hentry post-item">
                                    <a href="gioi-thieu-list/<?=$result_detailq[$i]['tenkhongdau']?>-<?=$result_detailq[$i]['id']?>.html" rel="bookmark"><img src="<?=_upload_gioithieu_l.$result_detailq[$i]['thumb']?>" class="img-responsive wp-post-image" alt="<?=$result_detailq[$i]['ten_en']?>"><?=$result_detailq[$i]['ten_en']?></a>
                                    <h4 class="entry-title"><a title="<?=$result_detailq[$i]['ten_en']?>" href="gioi-thieu-list/<?=$result_detailq[$i]['tenkhongdau']?>-<?=$result_detailq[$i]['id']?>.html"><?=$Summary?></a></h4>
                                    <div class="entry-meta hidden">
                                        <time class="meta-date updated" datetime="2017-02-05T21:47:35+00:00"><?=$result_detailq[$i]['ngaytao']?></time> <span class="p-author author h-card" itemprop="author">admin</span>
                                    </div><!-- .entry-meta -->
                                </div>
                            </div>
                         <?php

...
<?php 
		...
		$d->reset();
		$sql_tinll="select * from #_tinloai1_1 where id<>'$id' and ( hienngonngu =3 or hienngonngu =1) and id_list ='$id_list' and hienthi =1 order by id desc limit 3";
		$d->query($sql_tinll); 
...
<?php 
		...
		$id_list = $result_detail['id_list'];
		$d->reset();
		$sql_tinll="select * from #_tinloai1_1 where id<>'$id' and ( hienngonngu =3 or hienngonngu =2) and id_list ='$id_list' and hienthi =1 order by id desc limit 3";
		$d->query($sql_tinll); 
		$result_detailq=$d->result_array();
                ...
                <div id="main-content" class="border pad10">
                    ...
                    <div class="related-post">
                        ...
                        <?php
                         ...
                         <div class="col-md-4 col-sm-6">
                                <div class="hentry post-item">
                                    <a href="tin-tuc-detail/<?=$result_detailq[$i]['tenkhongdau']?>-<?=$result_detailq[$i]['id']?>.html" rel="bookmark"><img src="<?=_upload_tinloai1_1_l.$result_detailq[$i]['thumb']?>" class="img-responsive wp-post-image" alt="<?=$result_detailq[$i]['ten_en']?>"></a>
                                    <h4 class="entry-title"><a title="<?=$result_detailq[$i]['ten_en']?>" href="tin-tuc-detail/<?=$result_detailq[$i]['tenkhongdau']?>-<?=$result_detailq[$i]['id']?>.html"><?=$result_detailq[$i]['ten_en']?></a></h4>
                                    <div class="entry-meta hidden">
                                        <time class="meta-date updated" datetime="2017-02-05T21:47:35+00:00"><?=$result_detailq[$i]['ngaytao']?></time> <span class="p-author author h-card" itemprop="author">quantri</span>
                                    </div><!-- .entry-meta -->
                                </div>

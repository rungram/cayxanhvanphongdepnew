...
<div id="wrapper">
                    ...
                    <div id="pathway" class="clearfix">
                        <div class="container">
                            <div id="breadcrumbs" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                ...
                                <span class="hidden-xs">→</span>
                                <span itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                    <a href="san-pham.html" itemprop="item"><span itemprop="name">Cart</span></a>
                                    <meta itemprop="position" content="2">
                                </span>
                            </div><!-- #breadcrumbs -->
                        </div>
            ...
            <div class="page-content">
                 ...
                 <div class="table-responsive" id="no-more-tables">  
                     <table class="table table-hover table-vcenter"> 
                         <thead> 
                             <tr>
                                 <th class="text-left text-capitalize">  Product </th>
                                 <th class="text-center text-capitalize" style="width:120px;"> Unit price </th>
                                 <th class="text-center text-capitalize" style="width:80px;">  Quantity </th>
                                 <th class="text-center text-capitalize" style="width:80px;">  VAT </th>
                                <th class="text-center text-capitalize" style="width:80px;">  Shipping Charge (1 unit)</th>
                                 <th class="text-center text-capitalize" style="width:120px;">  Money </th>
                                 <th class="text-center" style="width:40px;"> </th>
                             </tr> 
                         </thead> 
                         <tbody> 
                     ...
                     $vat = 0;
                		...
                		?>
                             ...
                             <div class="media"> 
                                 ...
                                 <a href="chi-tiet-san-pham/<?=$pkodau?>-<?=$pid?>.html">
                                  ...
                                  <div class="media-body"> 
                                      <h4 class="media-heading"> 
                                      <a href="chi-tiet-san-pham/<?=$pkodau?>-<?=$pid?>.html" title="Giỏ Xách Kiểu 8"><?=$pname?></a> 
                                      <br> <br> Product code: <strong><?=$pma?></strong> </h4> 
                                  </div> 
                              </div> 
                          </td>
                         <td class="text-center"> <span class="visible-xs">Unit price</span> 
                         <?php 
        					if($psale ==0) 
        					echo number_format(get_price($pid),0, ',', '.').'₫';
        					else 
                         ...
                         <td class="text-center"> <span class="visible-xs">Quantity</span> 
                             <div class="input-group boxNumber"> 
                             <input onchange="updatecart()" type="number" step="1" min="0" name="product<?=$pid?>" value="<?=$q?>" title="SL" class="numberic form-control">
                             </div> 
                         </td>
                         ...
                         <td class="text-center"> <span class="visible-xs">Shipping Charge (1 unit)</span> 
                         <?php  
                             echo number_format(get_phivanchuyen($pid),0, ',', '.').'₫';
                         ?>
                             
                         </td>
                         <td class="text-right"> <span class="visible-xs">Money</span> <strong class="lblTotalPrice">
                         <?php 
						if($psale ==0) 
    						echo number_format(get_price($pid)*$q,0, ',', '.').'₫';
    						else 
 ...
 Delete </a>  
                 ...
                 <nav> 
                 <ul class="pager"> 
                 <li class="previous"><a href="san-pham.html"><span aria-hidden="true">←</span>Continue shopping</a></li>  
                 <?php if(count($_SESSION['cart'])>0)
                     {?>
                 <li class="next"><a href="thanh-toan.html"> Payment <span aria-hidden="true">→</span></a></li>  
                 <li class="next"><a href="javascript:;" onclick="return UpdateCart();"> <i class="fa fa-save"></i> Update Cart</a></li>  
                 <?php }?>

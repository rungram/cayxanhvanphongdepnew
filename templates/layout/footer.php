...
<?php 
	$d->reset();
	$sql_chinhsach ="select * from #_product where chinhsach = 1 and ( hienngonngu =3 or hienngonngu = 1) order by stt asc limit 0,5";
	...
	$d->reset();
	$sql_detailq="select * from #_tinloai1_1 where congty = 1 and ( hienngonngu =3 or hienngonngu = 1) order by id limit 5";
	$d->query($sql_detailq);
	$result_tincongty=$d->result_array();
	
	
	$d->reset();
	$sql_detailq="select * from #_tinloai1_1 where huongdan = 1 and ( hienngonngu =3 or hienngonngu = 1) order by id limit 6";
	$d->query($sql_detailq);
...
<?php 
	$d->reset();
	$sql_chinhsach ="select * from #_product where chinhsach = 1 and ( hienngonngu =3 or hienngonngu = 2) order by stt asc limit 0,5";
	$d->query($sql_chinhsach);
	$chinhsach=$d->result_array();
	...
	$d->reset();
	$sql_detailq="select * from #_tinloai1_1 where dichvu = 1 and ( hienngonngu =3 or hienngonngu = 2) order by id limit 6";
	$d->query($sql_detailq);
	$result_tindichvu=$d->result_array();
	
	
	$d->reset();
	$sql_detailq="select * from #_tinloai1_1 where congty = 1 and ( hienngonngu =3 or hienngonngu = 2) order by id limit 5";
	$d->query($sql_detailq);
	$result_tincongty=$d->result_array();
	
	
	$d->reset();
	$sql_detailq="select * from #_tinloai1_1 where huongdan = 1 and ( hienngonngu =3 or hienngonngu = 2) order by id limit 6";
	$d->query($sql_detailq);
	$result_tinhuongdan=$d->result_array();
?>
                ...
                <div class="container">
                    <div class="footer-static row">
                        <div class="f-col col-sm-4 col-md-4 col-sms-6 col-smb-12">
                            <div class="footer-static-content">
                                <div class="footer-static-title">
                                  <h3>COMPANY TREES OFFICE</h3></div>			<div class="textwidget">
                                    <?php
                                     for($i=0;$i<count($result_thongtincongty);$i++)
                                     { 
                                     ?>
                        ...
                        <div class="f-col f-col2 col-sm-2 col-md-2 col-sms-6 col-smb-12">
                            <div class="footer-static-content">
                                <div class="footer-static-title"><h3>Service</h3></div>			
                                <div class="textwidget">
                                    <ul>
                                    <?php
                                     for($i=0;$i<count($result_tindichvu);$i++)
                                     { 
                                     ?>
                                        <li><a href="tin-tuc-detail/<?=$result_tindichvu[$i]['tenkhongdau']?>-<?=$result_tindichvu[$i]['id']?>.html"><?=$result_tindichvu[$i]['ten_en']?></a></li>
                                      <?php }?> 
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="f-col f-col3 col-sm-3 col-md-3 col-sms-6 col-smb-12">
                            <div class="footer-static-content">
                                <div class="footer-static-title"><h3>Trees Office Beautiful</h3></div>			<div class="textwidget">
                                    <ul>
                                        <li class="first"><a href="lien-he.html">Contact</a></li>
                                        <?php
                                         for($i=0;$i<count($result_tincongty);$i++)
                                         { 
                                         ?>
                                        <li><a href="tin-tuc-detail/<?=$result_tincongty[$i]['tenkhongdau']?>-<?=$result_tincongty[$i]['id']?>.html"><?=$result_tincongty[$i]['ten_en']?></a></li>
                                        <?php }?>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="f-col f-col3 col-sm-3 col-md-3 col-sms-6 col-smb-12">
                            <div class="footer-static-content">
                                <div class="footer-static-title"><h3>Instruction</h3></div>			<div class="textwidget">
                                    <ul>
                                        <?php
                                         for($i=0;$i<count($result_tinhuongdan);$i++)
                                         { 
                                         ?>
                                        <li><a href="tin-tuc-detail/<?=$result_tinhuongdan[$i]['tenkhongdau']?>-<?=$result_tinhuongdan[$i]['id']?>.html"><?=$result_tinhuongdan[$i]['ten_en']?></a></li>
                                        <?php }?>
                                    </ul>
                                </div>
                            </div>

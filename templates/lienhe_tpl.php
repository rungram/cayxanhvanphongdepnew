                ...
                <div class="">
                    <div id="pathway" class="clearfix">
                        <div class="container">
                            <div id="breadcrumbs" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                ...
                                <span class="hidden-xs">→</span>
                                <span itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                    <a href="san-pham.html" itemprop="item"><span itemprop="name">Contact</span></a>
                                    <meta itemprop="position" content="2">
                                </span>
                            </div><!-- #breadcrumbs -->
                        </div>
                    ...
                    <div class="container">
                           ...
                           <div class="row border mar10">     
                                ...
                                <div class="col-md-6 col-sm-6">
                                	<div class="contact-info">
                                        You can send us a contact by completing the form below. We will reply to your letter, please complete the declaration. Pleased to serve and sincerely thank for your interest and contribution to us
                                    </div>
                                    <div class="divider"></div>
                                    <div class="contact-form">
                                    <form onsubmit="return alert('Send contact successfully');" method="post" name="frm" action="lien-he.html">
                                        <p class="full-row">
                                        ...
                                        <p class="full-row">
                                            <label for="subject-id">Topic:</label>
                                            <input type="text" id="subject-id" name="subject" required="required">
                                        </p>
                                        <p class="full-row">
                                        ...
                                        <input class="btn btn-success" name="" value="Send" type="submit">
                                    </form>
                                    </div>
                                </div> <!-- /.col-md-3 -->
                                <div class="col-md-6 col-sm-6">
